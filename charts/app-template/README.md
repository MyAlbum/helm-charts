...
| ------------------------------------- | ------ | ------- |
| https://myalbum.github.io/helm-charts | common | 4.4.0   |
...
Upgrade instructions can be found in the [documentation](https://myalbum.github.io/helm-charts/docs/app-template/#upgrade-instructions).

## Support

- See the [Docs](http://myalbum.github.io/helm-charts/docs/)
- Open an [issue](https://github.com/MyAlbum/helm-charts/issues/new/choose)
